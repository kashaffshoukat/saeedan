...
const CustomTeamCard = React.memo(
  ({ name, position, Image, backgroundColor, backgroundImage }) => {
        ...
        >
          <div>
            ...
            <div className="bg-white py-2 px-0 w-full absolute bottom-0 right-0 left-0 text-center shadow-md">
              ...
              <p className="text-base font-medium text-[#2e5090] text-left pl-5">
                {position}
              </p>
            </div>
          </div>
...
CustomTeamCard.displayName = "CustomTeamCard";
