...
const ServiceHomeCard = ({ icon, mainHeading, subHeadings }) => {
    return (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-gray-200 rounded-xl p-8 shadow-2xl max-w-md hover:bg-gradient-to-r hover:from-blue-500 hover:to-indigo-500 hover:text-white transition duration-100 h-full">
